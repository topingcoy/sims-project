...
Public Class rptListofCashColl
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.rptListofCashColl.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListofCashColl
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListofCashColl = New rptListofCashColl()
        rpt.Site = Me.Site
        Return rpt
    End Function
