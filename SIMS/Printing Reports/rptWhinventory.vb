...
Public Class rptWhinventory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.rptWhinventory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptWhinventory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptWhinventory = New rptWhinventory()
        rpt.Site = Me.Site
        Return rpt
    End Function
