...
Public Class rptListofCheckColl
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.rptListofCheckColl.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListofCheckColl
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListofCheckColl = New rptListofCheckColl()
        rpt.Site = Me.Site
        Return rpt
    End Function
