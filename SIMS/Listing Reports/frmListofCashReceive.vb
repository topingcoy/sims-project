...
Public Class frmListofCashReceive
    ...
    Private Sub frmListofCashReceive_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        dgvPayment.Rows.Clear()
                ...
                Using rd As MySqlDataReader = cmd.ExecuteReader
                    If rd.HasRows Then
                        ...
                        While rd.Read
                            ...
                            .Item(2, rw).Value = rd("edate").ToString
                            .Item(3, rw).Value = rd("docno").ToString
                            .Item(4, rw).Value = Format(CDbl(rd("refamt").ToString), "##,##0.00")
                        End While
                    End If
                    gettotal()
                End Using
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        ...
        With dgvPayment
            ...
            If .RowCount > 0 Then
                ...
                Dim dt As DataTable = ds.Tables("dtListofCashColl")
                Dim r1 As DataRow
                dt.Rows.Clear()
                '  Dim chkflag As Boolean = False
                grpno = 29
