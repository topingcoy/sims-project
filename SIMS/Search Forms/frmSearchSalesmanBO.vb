...
Public Class frmSearchSalesmanBO

    Private Sub frmSearchSalesmanBO_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LoadSalesman()
    End Sub
    Private Sub frmSearchSalesmanBO_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Keys.Space Then
            btnSelect.PerformClick()
        End If
    End Sub

    Private Sub frmSearchSalesmanBO_KeyUp(sender As Object, e As KeyEventArgs) Handles Me.KeyUp
        shortcutkeys(e)
    End Sub
    ...
    Sub LoadSalesman()
        ...
        cmd = New MySqlCommand("SELECT s.*,c.* FROM custsales s JOIN customers c ON s.custcode=c.custcode WHERE s.custcode like '" & frmSalesBOReturnD.txtCustCode.Text & "'", cdb)
