...
Public Class frmStockInD
    Dim loadcompleted As Integer = 0
    Dim editonoff As Integer = 0
    ...
    Private Sub frmStockInD_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmStockInD_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Sub GenerateStockInNo()
        ...
        If mdr.HasRows = True Then
            ...
            rcvtno = "I" & Strings.StrDup(9 - Strings.Len(rcvtno), "0") & rcvtno
            mdr.Close()
        Else
            mdr.Close()
            mdr.Dispose()
        ...
        With dgvItem
            If .RowCount > 0 Then
                ...
                ElseIf e.ColumnIndex = 3 Then
                    ...
                    If .Item(3, mrw).Value = 0 Then 'QTY
                        .CurrentCell = .Item(3, mrw)
                        MsgBox("Invalid quantity", 48, "Invalid quantity")
                    Else
                ...
                ElseIf e.ColumnIndex = 4 Then 'UNIT
                    ...
                    If .Item(3, mrw).Value = 0 Then 'if qty is eqaul to 0
                        '   .ClearSelection()
                        MsgBox("Invalid quantity", 48, "Invalid quantity")
                    Else
                        ...
                        getpackprice(itemno, mpc, mrw, cboPriceType.Text) 'gibalik ni richel
                        ...
                        ' Else
                        If .Item(1, mrw).Value <> Nothing Then ' if item code naay sulod
                            .ClearSelection()
                            Dim method As New SetColumnIndex(AddressOf Mymethod)
            ...
            If rd.HasRows Then
                ...
                With dgvItem
                    ...
                    ElseIf pck = "B" Then
                        ...
                        .Item(4, rx).Value = "B"
                        .Item(5, rx).Value = bpck
                        .Item(7, rx).Value = Format(.Item(3, rx).Value * bgprice, "STANDARD")
    ...
    Private Sub dgvItem_KeyDown(sender As Object, e As KeyEventArgs) Handles dgvItem.KeyDown
        ...
        With dgvItem
            If e.KeyCode = Keys.Enter And .CurrentCell.ColumnIndex = 4 Then
                Dim mrw As Integer
                Dim item4 As String
                item4 = .Item(1, mrw).Value
                .BeginEdit(True)
                e.Handled = True
    ...
    Private Sub cboWhsCode_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cboWhsCode.KeyPress
        If e.KeyChar = vbCr Then
            cbxSupplier.Focus()
        End If
    End Sub
    ...
    Private Sub btnCloseI_Click(sender As Object, e As EventArgs) Handles btnCloseI.Click
        ...
        If MsgBox("Are you sure you want to close?", vbYesNo + vbQuestion, "Misc. Stock In") = vbYes Then
            Me.Dispose()
        End If
        'End If
    End Sub
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If cbxSupplier.Text = "" Or cboWhsCode.Text = "" Then
            MsgBox("Check Missing Field", vbCritical)
            Exit Sub
        End If
    ...
    Sub SaveStockIn()
        ...
        TransNo = GenerateTransNo_In_Out_Transfer("I")
        Dim cmd As MySqlCommand
        Dim i As Integer
        ...
        With cmd
            ...
            cmd.Parameters.AddWithValue("@tdate", dtpStockIn.Value)
    ...
    Private Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        With dgvItem
            ...
            If cbxSupplier.Text <> Nothing And cboWhsCode.Text <> Nothing Then
                ...
                For i = 0 To .RowCount - 1
                    If .Item(3, i).Value <> Nothing Then 'qty <> nothing
                        If .Item(3, i).Value > 0 Then 'qty > 0
                            ...
                            whsecode2 = cboWhsCode.Text.Trim
    ...
    Sub RetrieveStockIn(ByVal trno As String)
        ...
        With dgvItem
            ...
            Using rd As MySqlDataReader = cmd.ExecuteReader
                If rd.HasRows Then
                    rd.Read()
                    dtpStockIn.Value = rd("tdate").ToString
    ...
    Private Sub dtpStockIn_KeyPress(sender As Object, e As KeyPressEventArgs) Handles dtpStockIn.KeyPress
        If e.KeyChar = vbCr Then
            cboWhsCode.Focus()
        End If
    End Sub

    Private Sub dtpStockIn_ValueChanged(sender As Object, e As EventArgs) Handles dtpStockIn.ValueChanged

    End Sub

    Private Sub cboWhsCode_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboWhsCode.SelectedIndexChanged
    ...
    Private Sub dgvItem_CellValueChanged(sender As Object, e As DataGridViewCellEventArgs) Handles dgvItem.CellValueChanged
