...
Public Class frmGStoBOD
    ...
    Private Sub frmGStoBOD_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Keys.F3 Then
            If btnSearch.Enabled = False Then
                MsgBox("Click Add Button First!", vbExclamation)
            Else
    ...
    Private Sub frmGStoBOD_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ttype = "B"
    ...
    Sub LoadWarehouse()
        ...
        Dim rmd As New MySqlCommand
        cboWhs.Items.Clear()
        cboWhs.DisplayMember = "text"
        qry = "Select * from warehouse ORDER BY warehouse"
        rmd = New MySqlCommand(qry, cdb)
        rmd.ExecuteNonQuery()
        Dim relr = rmd.ExecuteReader()
        While relr.Read()
            cboWhs.Items.Add(New With {.Text = relr("whscode").ToString(), .Value = relr("whscode").ToString()})
        End While
        relr.Close()
        rmd.Dispose()
    End Sub
                                    ...
                                    If .Item(1, rindex).Value <> Nothing And .Item(3, rindex).Value <> 0 And _
                                        ...
                                        If dgvItemList.Item(1, rdx).Value <> Nothing Then
                                            ...
                                            If .Item(9, rindex).Value <> dgvItemList.Item(1, rdx).Value Then
                                                ...
                                                listupd(rwupd).c1whse = cboWhs.SelectedItem.value
    ...
    Private Sub cboSupplier_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cboSupplier.KeyPress
    ...
    Private Sub cboWhs_SelectionChangeCommitted(sender As Object, e As EventArgs) Handles cboWhs.SelectionChangeCommitted
        cmd = New MySqlCommand("SELECT * from warehouse where whscode like '%" & cboWhs.Text & "%'", cdb)
        rd = cmd.ExecuteReader
        If rd.HasRows Then
            rd.Read()
            With rd
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        If cboSupplier.Text = "" Or cboWhs.Text = "" Then
        ...
        With dgvItem
            ...
            If .RowCount > 0 Then
                ...
                If asave = True Then
                    GenerateConvertedNo()
                    SaveConvertedBO()
                    MsgBox("Good Stock converted to BO has been save successfully", vbInformation)
                    Clears()
                    With frmGStoBOH
                        .LoadGStoBOH()
                    End With
    ...
    Sub SaveConvertedBO()
        ...
        With cmd
            ...
            cmd.Parameters.AddWithValue("@whscode", cboWhs.Text)
                ...
                If .Item(3, i).Value <> Nothing Then
                    If .Item(3, i).Value > 0 Then
                        cmd = New MySqlCommand("INSERT INTO ivd (transno,ttype,tdate,whscode,supcode,itemcode,qty,qunit,pckg, " & _
                                                      "price,amount) VALUES (@transno,@ttype,@tdate,@whscode,@supcode,@itemcode,@qty,@qunit,@pckg,@price,@amount)", cdb)
            ...
            For i = 0 To .RowCount - 1
                If .Item(3, i).Value <> Nothing Then
                    If .Item(3, i).Value > 0 Then
                        ...
                        cmd.Parameters.AddWithValue("@wh", cboWhs.Text.Trim)
                        Using rd As MySqlDataReader = cmd.ExecuteReader
                            If rd.HasRows Then
                                fnds = True
                                rd.Read()
                ...
                For i = 0 To .RowCount - 1
                    If .Item(3, i).Value <> Nothing Then
                        If .Item(3, i).Value > 0 Then
                            ...
                            If fnds = False Then
                                cmd = New MySqlCommand("INSERT INTO ivwh (itemcode,whscode,qty_bo) VALUES (@itm,@wh,@qtyb)", cdb)

                                cmd.Parameters.AddWithValue("@itm", .Item(1, i).Value)
                                cmd.Parameters.AddWithValue("@wh", cboWhs.Text.Trim)
                                cmd.Parameters.AddWithValue("@qtyb", totalqty)
                                cmd.ExecuteNonQuery()
                                cmd.Dispose()
                            Else
                                Dim nqty As Decimal = 0
                                nqty = totalqty + curqty
                                cmd = New MySqlCommand("UPDATE ivwh SET qty_bo=@qtyb WHERE itemcode=@itm AND whscode=@wh", cdb)
                                cmd.Parameters.AddWithValue("@itm", .Item(1, i).Value)
                                cmd.Parameters.AddWithValue("@wh", cboWhs.Text.Trim)
                                cmd.Parameters.AddWithValue("@qtyb", nqty)
                                cmd.ExecuteNonQuery()
                                cmd.Dispose()
                            End If
                        End If
    ...
    Private Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        With dgvItem
            ...
            If cboSupplier.Text <> Nothing And cboWhs.Text <> Nothing Then
    ...
    Sub update_currentwhs(ByVal itm As String, ByVal qty As Decimal, ByVal nwqty As Decimal, ByVal whs2 As String, ByVal whs1 As String, ByVal pv As String)
        ...
        cmd.Dispose()
    End Sub
    Sub update_currentwhs2(ByVal itm As String, ByVal qty As Decimal, ByVal nwqty As Decimal, ByVal whs2 As String)
    ...
    End Sub
    Sub update_currentwhs1(ByVal itm As String, ByVal qty As Decimal, ByVal nwqty As Decimal, ByVal whs2 As String, ByVal whs1 As String)
        ...
        With dgvItem
            ...
            For i = 0 To .RowCount - 1
                If .Item(3, i).Value <> Nothing Then 'qty <> nothing
                    If .Item(3, i).Value > 0 Then 'qty > 0
                        ...
                        qtyfromwhs = getcurqty(itmc, cboWhs.Text, "G")
                        unt = .Item(4, i).Value
            ...
            If mkerr = 0 Then
                For x = 0 To rwrmv - 1
                    ...
                    curqty = getcurqty(rmvitc, prevwhs, "G")
                    ...
                    cmd.Parameters.AddWithValue("@wh", prevwhs)
                    cmd.Parameters.AddWithValue("@qtyg", nwqty)
                    cmd.ExecuteNonQuery()
                    cmd.Dispose()

                    nwqty = 0
                    curqty = getcurqty(rmvitc, prevwhs, "B")
                    nwqty = curqty - totalqty
                ...
                For i = 0 To .RowCount - 1
                    If .Item(3, i).Value <> Nothing Then 'qty <> nothing
                        If .Item(3, i).Value > 0 Then 'qty > 0
                            ...
                            fnd1 = checkitemiffound(.Item(8, i).Value)

                            Dim unt As String = 0
                            Dim nwq As Decimal = 0
                            Dim qtyfromwhs As Decimal = 0
                            qtyfromwhs = getcurqty(itmc, cboWhs.Text, "B")
                            ...
                            If fnd1 = True Then
                                ...
                                If prevwhs <> cboWhs.Text Then
                                    Dim opr As String = Nothing
                                    opr = "-"
                                    pvwhs = prevwhs
                                    updateprevwhs(itmc, oqty, nwq, opr, prevwhs, "B")
                                End If

                                cmd = New MySqlCommand("UPDATE ivd SET ttype=@ttype,tdate=@tdate,whscode=@whscode,supcode=@supcode,itemcode=@itemcode,qty=@qty,qunit=@qunit,pckg=@pckg,price=@price,amount=@amount WHERE pkno=@pkno", cdb)
                                cmd.Parameters.AddWithValue("@transno", txtTransNo.Text)
                                cmd.Parameters.AddWithValue("@ttype", ttype)
                                cmd.Parameters.AddWithValue("@tdate", tDate.Value)
                                cmd.Parameters.AddWithValue("@whscode", cboWhs.Text)
                                ...
                                cmd.ExecuteNonQuery()
                                cmd.Dispose()
                                update_currentwhs11(itmc, oqty, nwq, cboWhs.Text, pvwhs, "B")
                            Else
                                cmd = New MySqlCommand("INSERT INTO ivd (transno,ttype,tdate,whscode,supcode,itemcode,qty,qunit,pckg, " & _
                                                       "price,amount) VALUES (@transno,@ttype,@tdate,@whscode,@supcode,@itemcode,@qty,@qunit,@pckg,@price,@amount)", cdb)
                                cmd.Parameters.AddWithValue("@transno", txtTransNo.Text)
                                ...
                                nwq = convertpackaging_fromivitem(itmc, pkn, newwqty, unt)
                                oqty = 0
                                update_currentwhs11(itmc, oqty, nwq, cboWhs.Text, cboWhs.Text, "B")
                                ' update_currentwhs2(itmc, oqty, newwqty, whsecode2)
                            End If
    ...
    Sub RetrieveConverted(ByVal trno As String)
        ...
        With dgvItem
            ...
            cmd = New MySqlCommand("SELECT h.*,s.suppliername,w.warehouse FROM ivh h " & _
                                   ...
                                   " LEFT JOIN warehouse w ON h.whscode=w.whscode WHERE transno=@tn and isdeleted='0' ", cdb)
            ...
            Using rd As MySqlDataReader = cmd.ExecuteReader
                If rd.HasRows Then
                    ...
                    cboWhs.SelectedIndex = setselindex(cboWhs, rd("whscode").ToString)
            ...
            cmd = New MySqlCommand("SELECT r.*,r.pkno as pno, t.description from ivd r " & _
                                   "LEFT JOIN ivitem t ON r.itemcode=t.itemcode WHERE transno=@tn and r.isdeleted='0' and r.ttype='B' Order by r.pkno Asc", cdb) ' '" & tbCustCode.Text & "'", cdb)
            cmd.Parameters.AddWithValue("@tn", trno)
            Using rd As MySqlDataReader = cmd.ExecuteReader
                If rd.HasRows Then
                    x = 0
